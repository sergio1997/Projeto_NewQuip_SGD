...
$motivo=$_POST['motivo'];
	 ...
	 $sqlinsere=  @mysql_query("INSERT INTO faltas(data_falta,motivo)VALUES('$data','$motivo')");


	$sql= @mysql_query("SELECT * FROM faltas WHERE data_falta='$data' AND motivo='$motivo'");
    ...
    $id_faltas=$exibe['id_falta'];
	  ...
	  $sqlinsere1=  @mysql_query("INSERT INTO codigo_faltas(id,id_faltas)VALUES('$id_funcionario','$id_faltas')");
