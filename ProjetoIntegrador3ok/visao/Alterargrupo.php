...
$sql=@mysql_query("SELECT * FROM setor WHERE id_setor='".$id."'"); // A instrução delete irá apagar todos os dados da id recebida

$exibe = @mysql_fetch_assoc($sql);
       $id_setor=$exibe['id_setor'];
       $nome_setor= $exibe['nome_setor'];
    ...
    <div class="form-group has-feedback">
       ...
       <div class="form-group has-feedback">
        ...
        <b>Nome do Setor<font color="#FF0000" >*</font></b> 
          <input type="text"  class="form-control" name="nome_setor" value="<?php echo "$nome_setor"?>" maxlength="40" placeholder="ex: Finaceiro" onKeypress='return soLetras(event)' />
      </div>
