...
$sql=@mysql_query("SELECT * FROM agendatarefa WHERE idagenda='".$id."'"); // A instrução delete irá apagar todos os dados da id recebida

$exibe = @mysql_fetch_assoc($sql);
       $id=$exibe['idagenda'];
       $grupo= $exibe['grupo'];
       $tarefa= $exibe['tarefa'];
       $tarefasfazer=$exibe['tarefasfazer'];
       $datainicio=$exibe['datainicio'];
       $horainicio=$exibe['horainicio'];
       $dataterminio=$exibe['dataterminio'];
       $horaterminio=$exibe['horaterminio'];
       $estimarticadata=$exibe['estimativadata'];
       $estimativahora=$exibe['estimativahora'];
       $produtividade=$exibe['produtividade'];           
                  ?>
  ...
  <aside class="main-sidebar">
    ...
    <section class="content">
     ...
     <div class="box-body">
      ...
      <form action="../modelo/salvarAlteracaoAngendamento.php" method="post" name="f1" onSubmit="return valida_dados(this)">
      
       <div class="form-group has-feedback">
        
        <b>Código<font color="#FF0000" >*</font></b> 
          <input type="text" name="idagenda" value="<?php echo "$id";?>" class="form-control" name="id" maxlength="40"  />
      </div>
    <div class="form-group has-feedback">
        
        <b>Setor<font color="#FF0000" >*</font></b> 
          <input type="text"  class="form-control" name="grupo" maxlength="40" value="<?php echo "$grupo";?>" />
      </div>
    <div class="form-group has-feedback">
          <b>Funcionarios do setor<font color="#FF0000" >*</font></b>
        ...
        <div class="form-group has-feedback">
          ...
          <textarea rows="4" cols="50" class="form-control" name="tarefas"  value="<?php echo "$tarefa";?>"><?php echo "$tarefa";?></textarea>
      
            </div>
        <div class="form-group has-feedback">
          <b>Tarefas ha Fazer<font color="#FF0000" >*</font></b>
                
          <textarea rows="4" cols="50" class="form-control" name="tarefasfazer" value="<?php echo "$tarefasfazer";?>" ><?php echo "$tarefasfazer";?></textarea>
      
            </div>
            <div class="form-group has-feedback">

      <b>Data do inicio<font color="#FF0000" >*</font></b> 
          <input type="date"  class="form-control" name="datainicio" maxlength="40" value="<?php echo "$datainicio";?>"  />
      </div>
            <div class="form-group has-feedback">

      <b>Hora do inicio <font color="#FF0000" >*</font></b> 
          <input type="time"  class="form-control" name="horainicio" maxlength="40" value="<?php echo"$horainicio";?>" />
      </div>
            <div class="form-group has-feedback">

      <b>Data de terminio<font color="#FF0000" >*</font></b> 
          <input type="date"  class="form-control" name="dataterminio" maxlength="40" value="<?php echo "$dataterminio";?>" />
      </div>
            <div class="form-group has-feedback">

      <b>Hora de Terminio<font color="#FF0000" >*</font></b> 
          <input type="time"  class="form-control" name="horaterminio" maxlength="40" value="<?php echo "$horaterminio";?>" />
      </div>
            <div class="form-group has-feedback">

      <b>Estimativa em Data<font color="#FF0000" >*</font></b> 
          <input type="date"  class="form-control" name="estimativadata" maxlength="40" value="<?php echo "$estimativadata";?>" />
      </div>
            <div class="form-group has-feedback">

      <b>Estimativa em hora<font color="#FF0000" >*</font></b> 
          <input type="time"  class="form-control" name="estimativahora" maxlength="40" value="<?php echo "$estimativahora";?>" />
      </div>
            <div class="form-group has-feedback">

      <b>Produtividade<font color="#FF0000" >*</font></b> 
          <input type="text"  class="form-control" name="produtividade" maxlength="3" placeholder="Ex: 100" value="<?php  echo "$produtividade";?>" />
      </div>
      <div>
