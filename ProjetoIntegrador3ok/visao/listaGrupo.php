                                        ...
                                        <tr>
                                            ...
                                            <tbody> 
                                                <tr>
                                                    ...
                                                    <td><a href="../modelo/Excluirgrupo.php?id=<?php echo $linha1['id_setor']; ?>" onClick="return confirm('Deseja realmente deletar o Setor: <?php echo $linha1['nm_setor']; ?> ?')"><button class="btn btn-primary">Excluir </button></a></td>
                                                </tr>
                                                <?php
