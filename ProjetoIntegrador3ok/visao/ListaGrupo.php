...
$query = @mysql_query("SELECT * FROM setor INNER JOIN codigo_setor ON codigo_setor.id_setor=setor.id_setor INNER JOIN funcionario ON codigo_setor.id=funcionario.id ");
// executa a query
...
$query1 = @mysql_query("SELECT * FROM setor");
// executa a query
...
if($total > 0) {
    ...
    do {
        ...
        }while($linha1 = mysql_fetch_assoc($query1)); //fimdo if
        }
