...
$query = @mysql_query("SELECT * FROM setor INNER JOIN codigo_setor ON codigo_setor.id_setor=setor.id_setor INNER JOIN funcionario ON codigo_setor.id=funcionario.id  WHERE codigo_setor.id_setor='$id_setor1'");
...
<thead>            
            <tr>
               <td ><strong>ID</strong> <td><strong>FUNCIONARIO</strong> </td><td><strong>SETOR</strong> </td>
<?php
...
if($total > 0) {
    ...
    do {
        ...
        <tbody>
        <tr>
        <td ><?=$linha['id']?> </td> <td><?=$linha['Nome']?></td><td><?=$linha['nome_setor']?></td>
        
             <td><a href="../visao/CadastraFaltas.php?id=<?php echo $linha['id']; ?>"><button class="btn btn-primary">Cadastar Ausencia</button></a></td>
              <td><a href="../visao/listarfaltas.php?id=<?php echo $linha['id']; ?>"><button class="btn btn-primary">Ausencias</button></a></td>
            <td><a href="../modelo/excluirFalta.php?id=<?php echo $linha['id']; ?>" onClick="return confirm('Deseja realmente deletar a Falta: <?php echo $linha['id']; ?> ?')"><button class="btn btn-primary">Outra função</button></a></td>
        </tr>
        </tr>
...
@mysql_free_result($dados);
 echo"<p>Total de Funcionario do Serto: $total<p>";
?>
