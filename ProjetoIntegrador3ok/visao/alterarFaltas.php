...
<?php 
 ...
 $query = mysql_query("SELECT *  FROM faltas WHERE id_falta='$id_falta'");
 $linha = @mysql_fetch_assoc($query);




$data_falta=$linha['data_falta']; 
$motivo=$linha['motivo'];
   ...
   <div class="content-wrapper">
    ...
    <section class="content">
     ...
     <div class="box-body">
      ...
      <form action="../modelo/inserealetracaoFalta.php" method="post" name="f1" onSubmit="return valida_dados(this)">
      
       <div class="form-group has-feedback">
        
        <b>Código<font color="#FF0000" >*</font></b> 
          <input type="text" value="<?php echo "$id_falta";?>" class="form-control" name="id" maxlength="40"  />
      </div>
      ...
      <b>Data da Ausêcia<font color="#FF0000" >*</font></b> 
          <input type="date"  class="form-control" name="data" maxlength="40" value="<?php echo "$data_falta";?>"  />
      </div>
            <div class="form-group has-feedback">

      <b>Motivo <font color="#FF0000" >*</font></b> 
          <input type="text"  class="form-control" name="motivo" maxlength="40" value="<?php echo"$motivo";?>" />
      </div>
