        ...
        <div class="content-wrapper">
            ...
            <section class="invoice">
                <div class="row">
                    <div class="col-md-12">
                        <div>
                            <h3 class="box-title">Informe o Período de Ademissões e Demisões</h3>
                        </div>
                        <div class="panel box box-primary">
                            ...
                            <form action="../visao/CalculaRotatividadeRH.php" method="post" name="f1" onSubmit="return valida_dados(this)">
